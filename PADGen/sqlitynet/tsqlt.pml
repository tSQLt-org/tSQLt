...
<PADGEN_PML>
	...
	<CompanyName />
	<Program_Info>
		<Program_Name>tSQLt</Program_Name>
		<Program_Version>7</Program_Version>
		...
		<Program_System_Requirements>MS SQL Server 2005+</Program_System_Requirements>
		<File_Info>
			<File_Size_Bytes>17500</File_Size_Bytes>
			<File_Size_K>17</File_Size_K>
	...
	<Program_Descriptions>
		<English>
			<Keywords>t-sql, unit testing, SQL-Server, TDD, Database TDD, Test Driven Development, SQL</Keywords>
			<Char_Desc_45>t-sql unit testing framework</Char_Desc_45>
			<Char_Desc_80>t-sql unit testing framework with support for dependency isolation</Char_Desc_80>
			<Char_Desc_250>tSQLt provides the ability to write unit tests for Microsoft SQL Server T-SQL code. Unlike other frameworks it allows the developer to isolate the unit being tested. For example, it can fake tables or views, spy procedures and test constraints.</Char_Desc_250>
			<Char_Desc_450>tSQLt provides the ability to write unit tests for Microsoft SQL Server T-SQL code. Unlike other frameworks it allows the developer to isolate the unit being tested. For example, it can fake tables or views, spy procedures and test constraints.</Char_Desc_450>
			<Char_Desc_2000>- What is tSQLt?
...
Provides the ability to fake tables and views, and to create stored procedure spies - allowing you to isolate the code which you are testing</Char_Desc_2000>
		</English>
	</Program_Descriptions>
	<Web_Info>
		<Application_URLs>
			<Application_Info_URL>http://tsqlt.org</Application_Info_URL>
		...
		<Download_URLs>
			<Primary_Download_URL>http://sourceforge.net/projects/tsqlt/</Primary_Download_URL>
