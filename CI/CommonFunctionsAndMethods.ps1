...
Function Log-Output{[cmdletbinding()]Param([parameter(ValueFromPipeline)]$I);Process{Write-Verbose ([string]::Concat($GetUTCTimeStamp.Invoke()[0],[string]::Concat($I))) -Verbose;};};
